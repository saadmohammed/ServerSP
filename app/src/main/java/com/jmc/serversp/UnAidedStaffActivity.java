...
public class UnAidedStaffActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_un_aided_staff);

        relativeLayout = findViewById(R.id.UnAidedRelativeLayout);

        Toolbar toolbar = findViewById(R.id.toolbarUnAided);
        toolbar.setTitle("UnAided Staff");
        setSupportActionBar(toolbar);
        toolbar.setTitleTextColor(getResources().getColor(android.R.color.white));

        db = FirebaseDatabase.getInstance();
        staffList = db.getReference("UnAided");
        storage = FirebaseStorage.getInstance();
        reference = storage.getReference();

        //Init
        recyclerView = findViewById(R.id.recyclerViewUnAided);
        recyclerView.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);

        //Fab
        fab = findViewById(R.id.fabUnAidedStaff);
    ...
    private void showAddStaffDialog() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(UnAidedStaffActivity.this);
            ...
            imageFolder.putFile(saveUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            mDialog.dismiss();
                            Toast.makeText(UnAidedStaffActivity.this,"Uploaded Successfully",Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            mDialog.dismiss();
                            Toast.makeText(UnAidedStaffActivity.this,""+e.getMessage(),Toast.LENGTH_SHORT).show();
    ...
    public boolean onContextItemSelected(@NonNull final MenuItem item) {
        ...
        if (item.getTitle().equals(Common.UPDATE)){
            ...
            final AlertDialog.Builder alertDialog = new AlertDialog.Builder(UnAidedStaffActivity.this);
    ...
    private void deleteStaff(String key) {
        ...
        DatabaseReference staff = db.getReference("UnAided");
